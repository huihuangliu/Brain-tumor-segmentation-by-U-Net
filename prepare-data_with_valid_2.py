...
HGG_data_path = "./BRATS-Training/HGG"
LGG_data_path = "./BRATS-Training/LGG"
#survival_csv_path = "data/Brats17TrainingData/survival_data.csv"
#survival_csv_path = "/home/wangxuchu/LiuHuiHuang"     #这个先不管了
###==========================================================================###
...
if DATA_SIZE == 'all':
    ...
    HGG_path_list = tl.files.load_folder_list(path=HGG_data_path)[0:12] # DEBUG WITH SMALL DATA
    LGG_path_list = tl.files.load_folder_list(path=LGG_data_path)[0:9] # DEBUG WITH SMALL DATA
    #HGG_path_list = glob.glob(HGG_data_path)[0:12] # DEBUG WITH SMALL DATA
    #LGG_path_list = glob.glob(LGG_data_path)[0:9] # DEBUG WITH SMALL DATA
else:
    exit("Unknow DATA_SIZE")
print(len(HGG_path_list), len(LGG_path_list)) #210 #75

HGG_name_list = [os.path.basename(p) for p in HGG_path_list]   #HGG文件名
LGG_name_list = [os.path.basename(p) for p in LGG_path_list]    #LGG文件名
